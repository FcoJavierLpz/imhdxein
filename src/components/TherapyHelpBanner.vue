...
<template>
  ...
  >
    ...
    <div class="mt-4 flex flex-col gap-2">
      ...
      <a :href="whatsappHref" target="_blank" rel="noopener noreferrer" class="therapy-help-banner__cta-primary" :tabindex="visible ? 0 : -1">
...
.therapy-help-banner.is-visible {
  opacity: 1;
